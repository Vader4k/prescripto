  ...
  return (
    <section className="flex flex-col h-full px-6 bg-primary md:flex-row md:px-10 lg:px-20 rounded-2xl">
      <div className=" w-1/2 flex flex-col items-start justify-center gap-8 py-10 m-auto md:py-[10vw] md:mb-[-30px] text-gray-800">
        <h1 className="text-3xl font-bold text-white capitalize md:text-4xl lg:text-5xl">Book Appointment <br />With Trusted Doctors</h1>
      ...
      <div className="relative w-1/2">
        <img className="w-full h-[80%] absolute bottom-0" src={assets.header_img} alt="hero_image" />
      </div>
    </section>
  )
}
